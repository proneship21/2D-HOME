var editor = {
  ...
  showScaleBox: function () {
    if (ROOM.length > 0) {
        ...
        var areaInSquarePixels = width * height;
        var areaInSquareMeters = (areaInSquarePixels / (meter * meter)).toFixed(2);

        var labelWidth = ((maxX - minX) / meter).toFixed(2);
        var labelHeight = ((maxY - minY) / meter).toFixed(2);

        var estimatedCostRoughFinish = addCommas((areaInSquareMeters * 22000).toFixed(2));
        var estimatedCostBasicFinish = addCommas((areaInSquareMeters * 25000).toFixed(2));
        var estimatedCostStandardFinish = addCommas((areaInSquareMeters * 30000).toFixed(2));
        var estimatedCostLuxuriousFinish = addCommas((areaInSquareMeters * 42000).toFixed(2));
        ...
        $('#roughFinishCost').text(estimatedCostRoughFinish + ' PHP');
        $('#basicFinishCost').text(estimatedCostBasicFinish + ' PHP');
        $('#standardFinishCost').text(estimatedCostStandardFinish + ' PHP');
        $('#luxuriousFinishCost').text(estimatedCostLuxuriousFinish + ' PHP');
    }
